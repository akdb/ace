...
define regacecallback

CALLBACKS := $(CALLBACKS) acehandler,$(1),$(2)
...
$(foreach src,$(ACE_SOURCES),$(eval $(call regacecallback,$(addprefix ../build/,$(subst .aces,.acec,$(notdir $(src)))),$(src))))
